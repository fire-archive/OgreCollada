...
**
** Created: Mon May 25 21:51:04 2009
**      by: The Qt Meta Object Compiler version 61 (Qt 4.5.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../include/TestWidget.h"
...
const QMetaObject TestWidget::staticMetaObject = {
    { &QOgreWidget::staticMetaObject, qt_meta_stringdata_TestWidget,
      qt_meta_data_TestWidget, 0 }
};
...
void *TestWidget::qt_metacast(const char *_clname)
{
    ...
    return QOgreWidget::qt_metacast(_clname);
}

int TestWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QOgreWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
